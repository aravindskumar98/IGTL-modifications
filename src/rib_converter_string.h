...
class RIBConverterString : public RIBConverter<cpp_parameter_event_handler::msg::String>
{
...
protected:
  virtual void onROSMessage(const cpp_parameter_event_handler::msg::String::SharedPtr msg);
};
