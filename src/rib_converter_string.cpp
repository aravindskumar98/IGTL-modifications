...
RIBConverterString::RIBConverterString()
  : RIBConverter<cpp_parameter_event_handler::msg::String>()
{
}

RIBConverterString::RIBConverterString(rclcpp::Node::SharedPtr n)
  : RIBConverter<cpp_parameter_event_handler::msg::String>(n)
{
}

RIBConverterString::RIBConverterString(const char* topicPublish, const char* topicSubscribe, rclcpp::Node::SharedPtr n)
  : RIBConverter<cpp_parameter_event_handler::msg::String>(topicPublish, topicSubscribe, n)
{
}
...
int RIBConverterString::onIGTLMessage(igtl::MessageHeader * header)
{
  ...
  cpp_parameter_event_handler::msg::String msg;
...
void RIBConverterString::onROSMessage(const cpp_parameter_event_handler::msg::String::SharedPtr msg)
{
  igtl::Socket::Pointer socket = this->manager->GetSocket();
